...
## تحسينات الواجهة للهاتف المحمول
- [x] تحسين التصميم الاستجابي (Responsive Design)
- [x] تحسين الملاحظة على الهاتف
- [x] تحسين حجم الخطوط والأزرار
- [x] تحسين الصور والتخطيط
- [x] تحسين الأداء على الاتصالات البطيئة
- [x] إضافة قائمة جانبية قابلة للطي (هامبرجر منيو)
- [x] تحسين نموذج إضافة الأعمال للهاتف
- [x] إنشاء مكون Navigation مركزي
- [x] تحديث صفحة Home.tsx بتصميم محسّن للهاتف
- [x] تحديث صفحة Works.tsx بتصميم محسّن للهاتف


## ميزات جديدة إضافية
- [x] إضافة نظام التقييمات المتقدم مع فلاتر حسب التاريخ والتقييم
- [x] إضافة ميزة المفضلة (Favorites) لحفظ الأعمال المفضلة
- [x] إضافة إمكانية رفع الصور من الهاتف أو الحاسوب
- [x] تحديث قاعدة البيانات لدعم الصور المرفوعة
- [x] إضافة واجهة رفع الصور في لوحة التحكم
- [x] إنشاء مكون ImageUploader للرفع من الهاتف والحاسوب
- [x] إضافة إجراءات tRPC للمفضلة والتقييمات المتقدمة
- [x] إضافة إجراء رفع الصور في routers.ts
